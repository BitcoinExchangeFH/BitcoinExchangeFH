...
class ExchGwOkCoinCNWs(WebSocketApiClient):
    """
    Exchange socket
    """
    def __init__(self):
        ...
        Constructor
        """
        WebSocketApiClient.__init__(self, 'ExchGwOkCoinCN')
    ...
    @classmethod
    def get_link(cls):
        return 'wss://real.okcoin.cn:10440/websocket/okcoinapi'
...
class ExchGwOkCoinCN(ExchangeGateway):
    """
    Exchange gateway
    """
    def __init__(self, db_clients):
        ...
        """
        ExchangeGateway.__init__(self, ExchGwOkCoinCNWs(), db_clients)
