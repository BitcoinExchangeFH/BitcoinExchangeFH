...
class Snapshot(MarketDataBase):
    ...
    def columns(is_name=True):
        ...
        """
        if is_name:
            return ['exchange', 'instmt', 'trade_side',
            ...
            return ['trade_side', 'trade_px', 'trade_volume',
                    'b1', 'b2', 'b3', 'b4', 'b5',
                    'a1', 'a2', 'a3', 'a4', 'a5',
                    'bq1', 'bq2', 'bq3', 'bq4', 'bq5',
                    'aq1', 'aq2', 'aq3', 'aq4', 'aq5',
    ...
    def types(is_name=True):
        ...
        """
        if is_name:
            return ['varchar(20)', 'varchar(20)', 'int', 'decimal(20,8)', 'decimal(20,8)'] + \
                   ['decimal(20,8)'] * 10 + \
                   ['decimal(20,8)'] * 10 + \
                   ['varchar(25)', 'varchar(25)', 'int']
        else:
            return ['int', 'decimal(20,8)', 'decimal(20,8)'] + \
                   ['decimal(20,8)'] * 10 + \
                   ['decimal(20,8)'] * 10 + \
                   ['varchar(25)', 'varchar(25)', 'int']
