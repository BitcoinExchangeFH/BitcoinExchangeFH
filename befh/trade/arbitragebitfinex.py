...
if __name__ == '__main__':
    ...
    arbitrage_record = {}
    withdrawrecords = {}
    globalvar = {"threshholdfloor": 30000, "threshholdceil": 60000, "BTC": 0.01, "ETH": 0.01, "LTC": 0.1}
    ...
    while True:
        ...
        try:
            ...
            tradesymbol = ['BTC', 'ETH']
            arbitrade.Exchange3Arbitrage(mjson, "OkCoinCN", "Bitfinex", tradesymbol[0], tradesymbol[1],
                                         globalvar[tradesymbol[0]], globalvar[tradesymbol[1]], 0.003)
            tradesymbol = ['BTC', 'LTC']
            arbitrade.Exchange3Arbitrage(mjson, "OkCoinCN", "Bitfinex", tradesymbol[0], tradesymbol[1],
                                         globalvar[tradesymbol[0]], globalvar[tradesymbol[1]], 0.003)
